 ...
 */
  ...
  var n = d.toDateString();
	if (d.getFullYear() < 2015){ // <---- ***FUTURE UPDATES WILL BE NEEDED | Current academic year***
		document.getElementById("jumpToToday").href = "#Aug17";
	}
	else if (d.getFullYear() == 2015){ // <---- ***UPDATE***
		if (d.getMonth() == 7){
			if (d.getDate() < 17){ // <---- ***UPDATE***
				document.getElementById("jumpToToday").href = "#Aug17"; // <---- ***UPDATE***
			}
			else{
				document.getElementById("jumpToToday").href = "#" + (n.substring(n.indexOf(" ")+1,n.indexOf(" ",n.indexOf(" ")+1)) ) + (n.substring(n.indexOf(" ",n.indexOf(" ")+1)+1,n.indexOf(" ", n.indexOf(" ", n.indexOf(" ")+1)+1)) );
			}
		}
			...
			if (d.getDate() <= 18){ // <---- ***FUTURE UPDATES WILL BE NEEDED | Ending day of current Spring semester***
				...
				document.getElementById("jumpToToday").href = "#Dec18"; // <---- ***UPDATE***
			}
		}
		else{
			document.getElementById("jumpToToday").href = "#Aug17"; // <---- ***UPDATE***
